...
// //   const [data, setData] = useState({ Blogs: [], Events: [], "Press Release": [] });
...
// //           description: "The global Artificial Intelligence (AI) market, valued at over $200 billion, is reshaping industries and redefining the future of automation, decision-making, and digital services at scale.",
// //           author: "Rania Wehbi",
// //           image: "/assets/press-3.jpg",
// //         },
// //         {
// //           title: "Leveraging Platformation for Public Sector Transformation",
// //           description: "As organizations in the UAE continue to navigate the complexities of digital transformation, Platformation provides a strategic path for government scalability and resilience.",
// //           author: "Ossama El Samadoni",
// //           image: "/assets/press-4.jpg",
// //         },
// //         {
// //           title: "Simplifying the Transition to Hybrid MultiCloud",
// //           description: "Organizations today face mounting pressure to innovate and streamline operations to stay competitive. Hybrid MultiCloud solutions combine public, private, and edge computing seamlessly.",
// //           author: "Somas K Balasubramanian",
// //           image: "/assets/press-5.jpg",
// //         },
// //         {
// //           title: "Future of Banking: Embracing the Experiential, Collaborative",
// //           description: "The banking sector in the UAE has always been among the leaders in adapting quickly to change. The focus is now shifting toward enhancing user experience, agility, and service automation.",
...
// //           description: "AI is transforming the way we live our lives with intelligent systems, smart cities, and autonomous solutions. This summit will showcase top regional innovation in AI and digital services.",
// //           date: "28-Apr-2025",
// //           location: "Kuwait",
...
// //           description: "COMMNET is proud to bring the innovation story to Kuwait’s top cybersecurity stage. Join us as we unveil the future of secure digital infrastructure.",
// //           date: "22-Apr-2025",
// //           location: "Kuwait",
...
// //           description: "Secure your business with the next-gen application delivery and security solutions that reduce total cost of ownership while improving scale and automation.",
// //           date: "30-May-2025",
// //           location: "Dubai - UAE",
...
// //           description: "Learn how F5 WAAP and COMMNET's security experts are protecting modern workloads using adaptive threat models and holistic API protection frameworks.",
// //           date: "30-May-2025",
// //           location: "Dubai - UAE",
...
// //           description: "COMMNET, a leading digital solutions provider, is marking its 35th anniversary with a renewed focus on hybrid cloud, AI, and intelligent networking. Celebrations will be held across all regions.COMMNET, a leading digital solutions provider, is marking its 35th anniversary with a renewed focus on hybrid cloud, AI, and intelligent networking. Celebrations will be held across all regions.",
// //           image: "/assets/pic-1.jpg",
// //         },
// //         {
// //           title: "COMMNET Partners with Splunk to Drive Transformation",
// //           description: "Enhance threat detection, secure systems and safeguard data with COMMNET and Splunk’s joint enterprise analytics and observability platform.COMMNET, a leading digital solutions provider, is marking its 35th anniversary with a renewed focus on hybrid cloud, AI, and intelligent networking. Celebrations will be held across all regions.",
// //           image: "/assets/pic-2.jpg",
// //         },
// //         {
// //           title: "COMMNET to Deliver Comprehensive IT Services",
// //           description: "This strategic partnership will see COMMNET oversee complete infrastructure, cloud, cybersecurity, and software modernization for major clients in finance and government.COMMNET, a leading digital solutions provider, is marking its 35th anniversary with a renewed focus on hybrid cloud, AI, and intelligent networking. Celebrations will be held across all regions.",
// //           image: "/assets/pic-3.jpg",
// //         },
// //         {
// //           title: "COMMNET to Implement Next-Gen Firewall Solutions",
// //           description: "Zero-trust tech offers multiple advantages. COMMNET's integration with top firewall vendors brings deep inspection, cloud-native access control, and threat intelligence in one suite.",
// //           image: "/assets/pic-1.jpg",
// //         },
// //       ];

// //       setData({ Blogs: blogData, Events: eventData, "Press Release": pressData });
// //     }
...
// //               {item.title}
// //             </h3>
// //             <p className="text-sm text-gray-700 font-['Lato'] mb-3">{item.description}</p>
// //             {item.author && (
...
// //             )}
// //             {item.date && (
// //               <p className="text-xs text-gray-500 mt-2 font-['Lato']">{item.date}</p>
// //             )}
// //             {item.location && (
...
// //             )}
// //           </div>
// //           <img src={item.image} alt="media" className="w-full h-[250px] object-cover" />
// //         </div>
// //       ))}
// //     </div>
// //   );
...
// //   return (
// //     <section
// //   className="px-6 md:px-16 py-12 min-h-screen font-['Lato'] bg-cover bg-center bg-no-repeat"
// //   style={{ backgroundImage: "url('/assets/bg-2.jpg')" }}
// // >

// // <div className="flex items-center justify-start space-x-10 pb-4">
