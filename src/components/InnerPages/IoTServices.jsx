      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-Bold">Our IoT Capabilities</p>
            <p>We offer easily deployable solutions for enterprises that gather data from sensors to provide actionable business insights.
