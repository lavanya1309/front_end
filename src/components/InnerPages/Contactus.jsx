...
//       {/* Hero Section */}
//       <section className="relative w-full h-[90vh] bg-cover bg-center flex items-center justify-start px-10 bg-[url('/assets/pic-2.jpg')]">
...
//             <h2 className="text-3xl font-bold">Contact <span className="text-sky-600">Details</span></h2>
...
//               <input placeholder="Select Enquiry Subject" className="border-b p-2 outline-none" />
//               <input placeholder="Title" className="border-b p-2 outline-none" />
//               <input placeholder="Your Name" className="border-b p-2 outline-none" />
//               <input placeholder="Phone" className="border-b p-2 outline-none" />
//               <input placeholder="Email" className="border-b p-2 outline-none" />
//               <input placeholder="Job Title" className="border-b p-2 outline-none" />
//               <input placeholder="Company Name" className="border-b p-2 outline-none" />
//               <input placeholder="Industry" className="border-b p-2 outline-none" />
//               <input placeholder="Country" className="border-b p-2 outline-none" />
...
//               <button
//                 type="submit"
//                 className="bg-sky-600 text-white px-6 py-2 rounded-lg w-32"
//               >
//                 Submit
//               </button>
//             </form>
