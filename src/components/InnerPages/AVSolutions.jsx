...
// import HeroBg from "/assets/av-1.jpg";
// import OverviewImg from "/assets/swiper/av.jpg";
...
//     {/* Left Side Text */}
//     <div>
//       <h2 className="text-3xl md:text-4xl font-bold mb-2 uppercase">Audiovisual Systems</h2>
...
//           "Collaborative Learning Centers and Training Rooms",
//           "Smart Field Workers and Collaborative Working Environment – CWE",
//           "AV Processing, Control and Integrations",
//           "Video Walls, LED displays, Projection solutions & Screens",
//           "Video Conferencing, Lecture Capture and AV Streaming",
//           "Discussion, Interpretation and Conference solutions",
//           "IPTV, Digital Signage & Room Booking",
//           "Command & Control Centers solutions",
//           "Interactive & Collaboration Solutions",
//           "Public Address & BGM",
//           "Tailored Pro AV Solutions",
//         ].map((item, index) => (
    ...
    <div className="w-full font-sans text-black">
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          {/* Left Side Text */}
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-2 uppercase  text-sky-600">
              Audiovisual Systems
            </h2>
            <p className="text-gray-600 mb-6">
              Commnet deploy our design talents and engineering capabilities to deliver customized user-friendly AV solutions that meet client expectations, budgets and timeframes.
