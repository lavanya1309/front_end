...
// import HeroBg from "/assets/IS-3.jpg";
// import OverviewImg from "/assets/IS-4.jpg";
...
// </p>
//              <p>We start with identifying gaps in existing information security policy. We build inventory of information assets and statement of applicability. And then move on to publishing risk treatment plan and security policy</p>
//              <p>Our reports are more than a bunch of papers. They highlight areas of maximum risk and impact. They showcase proof-of-concept exploits. They contain statistics of the number of vulnerabilities. Not just that, they also suggest solutions for immediate and tangible improvements
// </p>
//              <p>Now it's time to identify gaps in the new controls through internal audit. And prepare for final certification. We help you build an evolving policy and provide checkpoint audits to stay compliant over a period of time
// </p>
//              <p>Commnet is a CERT-IN empanelled security auditor and ranks top 4 on the panel of IT security auditing organisations in India. Our team consists of consultants and auditors who are well versed in globally accepted information security standards: ISO27001, ISO 20000, OSSTMM, SSE-CMM,CobIT and OWASP, you name it and we have it
// </p>
// <p>You build response to legal requirements and potential security threats such as, virus attacks, hacking, natural disasters, information theft and information misuse. And stay compliant to ISO27001 year on year.</p>
//             </div>
//           </div>
          ...
          <div>
            ...
            <div className="space-y-6 text-gray-800 leading-relaxed text-base md:text-lg">
              <p>
                ...
                adequate and proportionate security controls to help you manage
                and protect your valuable information assets. Our security
                consultants evaluate your organisation's security policies,
                procedures, standards and organisation structure against the ISO27001
                standard.
              </p>
              <p>
                We start with identifying gaps in existing information security policy.
                We build inventory of information assets and statement of applicability.
                And then move on to publishing risk treatment plan and security policy.
              </p>
              <p>
                Our reports are more than a bunch of papers. They highlight areas of
                maximum risk and impact. They showcase proof-of-concept exploits. They
                contain statistics of the number of vulnerabilities. Not just that, they
                also suggest solutions for immediate and tangible improvements.
              </p>
              <p>
                Now it's time to identify gaps in the new controls through internal
                audit. And prepare for final certification. We help you build an evolving
                policy and provide checkpoint audits to stay compliant over a period of
                time.
              </p>
              <p>
                Commnet is a CERT-IN empanelled security auditor and ranks top 4 on the
                panel of IT security auditing organisations in India. Our team consists
                of consultants and auditors who are well versed in globally accepted
                information security standards: ISO27001, ISO 20000, OSSTMM, SSE-CMM,
                CobIT and OWASP, you name it and we have it.
              </p>
              <p>
                You build response to legal requirements and potential security threats
                such as, virus attacks, hacking, natural disasters, information theft and
                information misuse. And stay compliant to ISO27001 year on year.
              </p>
            </div>
          </div>
